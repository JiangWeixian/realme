...
export const $styles = css`
  ...
  .device-apple-watch-ultra .device-frame::before {
    ...
    border-radius: 80px;
    box-shadow: 0 0 6px rgba(13, 13, 13, 0.2), inset 0 0 4px 1px #f5f2f0, inset 0 0 0 10px #d6ccc2;
    content: '';
    height: 356px;
    left: 12px;
    position: absolute;
  ...
  .device-apple-watch-ultra .device-header {
    ...
    box-shadow: inset 0 0 16px 1px rgba(13, 13, 13, 0.5), -8px 0 4px rgba(13, 13, 13, 0.2),
      inset 4px 0 4px rgba(13, 13, 13, 0.2);
    height: 214px;
    margin-top: -107px;
    position: absolute;
    right: 4px;
  ...
  .device-apple-watch-ultra .device-btns::before {
    ...
    box-shadow: 0 -30px rgba(163, 140, 118, 0.5), 0 -27px #d6ccc2, 0 -25px #89735c,
      ...
      0 -3px rgba(163, 140, 118, 0.5), 0 0 #d6ccc2, 0 2px #89735c, 0 6px rgba(163, 140, 118, 0.5),
      0 9px #d6ccc2, 0 11px #89735c, 0 15px rgba(163, 140, 118, 0.5), 0 18px #d6ccc2, 0 20px #89735c,
  ...
  .device-apple-watch-s8 .device-btns::before {
    background: #272c31;
    border-radius: 20%;
    box-shadow: 0 -30px rgba(62, 70, 77, 0.75), 0 -27px #272c31, 0 -25px black,
      0 -21px rgba(62, 70, 77, 0.75), 0 -18px #272c31, 0 -16px black, 0 -12px rgba(62, 70, 77, 0.75),
      0 -9px #272c31, 0 -7px black, 0 -3px rgba(62, 70, 77, 0.75), 0 0 #272c31, 0 2px black,
      0 6px rgba(62, 70, 77, 0.75), 0 9px #272c31, 0 11px black, 0 15px rgba(62, 70, 77, 0.75),
      0 18px #272c31, 0 20px black, 0 24px rgba(62, 70, 77, 0.75), 0 27px #272c31, 0 29px black;
    content: '';
    height: 3px;
    margin-top: -2px;
    position: absolute;
  ...
  .device-homepod .device-frame {
    ...
    border-radius: 80px;
    box-shadow: inset 0 0 0 2px #36373a, inset 0 0 40px 1px #1d1e20, inset 0 12px 40px 1px white,
      inset 0 -24px 40px 1px black;
    height: 385px;
    margin: 5px auto;
    overflow: hidden;
    position: relative;
  ...
  .device-homepod .device-stripe {
    ...
    border-radius: 80px;
    box-shadow: inset 0 0 0 2px #36373a, inset 0 0 40px 1px #1d1e20, inset 0 12px 24px 1px #9b9ca1,
      inset 0 -12px 24px 1px #050505;
    height: 385px;
    left: 0;
    overflow: hidden;
    position: absolute;
